...
<head>
    ...
    <style>
        ...
        * {
        ...
        .bg-custom-pending    { background-color: #fcd80bff !important; color: #000 !important; }
        .bg-custom-accepted   { background-color: #bcfc81ff !important; color: #000 !important; }
        .bg-custom-confirmed  { background-color: #8be200f1 !important; color: #000 !important; }
        .bg-custom-reserved   { background-color: #7bff86ff !important; color: #000 !important; }
        .bg-custom-cancelled  { background-color: #ff91edff !important; color: #000 !important; }
        .bg-custom-rejected   { background-color: #ff8383ff !important; color: #000 !important; }
        .bg-custom-rescheduled{ background-color: #f8a808ff !important; color: #000 !important; }
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <dl class="row reservation-dl">
                                                    ...
                                                    @if(!in_array($reservation->status, [5, 6, 7]) && max(0, (($reservation->charge - $reservation->discount_custom) + $reservation->deposit) - $totalPaid) > 0)
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="alert alert-info">                                            
                                                ...
                                                @elseif($reservation->status == 2)
                                                    <p class="mb-3 text-dark" style="font-size: 1.1rem;">Please transfer Rs. {{ number_format($preliminaryPayment, 2) }} to the following bank account and upload your payment receipt below:</p>
                                                @elseif($reservation->status == 3)
                                                    <p class="mb-3 text-dark" style="font-size: 1.1rem;">Please transfer Rs. {{ number_format($remainingAmount, 2) }} to the following bank account and upload your payment receipt below:</p>
                                                @elseif($reservation->status == 4)
                                                    <p class="mb-3 text-dark" style="font-size: 1.1rem;">Everything is paid already.</p>
                                                @elseif($reservation->status == 5)
                                                    <p class="mb-3 text-dark" style="font-size: 1.1rem;">Since cancelled nothing to pay</p>
                                                @elseif($reservation->status == 6)
                                                    <p class="mb-3 text-dark" style="font-size: 1.1rem;">Nothing to pay. You have just re-scheduled.</p>
                                                @else
                                                @endif
