...
<head>
    ...
    <style>
        ...
        * {
        ...
        .navbar-show .navbar-brand i {
            color: var(--primary);
            margin-right: 10px;
        }

        .navbar-show .nav-user {
            font-weight: 500;
            font-size: 0.9rem;
            color: var(--gray);
            display: flex;
        ...
        .total-charge-box .charge-amount {
            color: #fff;
        }
        ...
        /* Status alerts */
        #customTimeStatusRegular.alert-success,
        #customTimeStatusPackage.alert-success {
            border-left: 4px solid var(--success);
        }

        #customTimeStatusRegular.alert-danger,
        #customTimeStatusPackage.alert-danger {
            border-left: 4px solid var(--danger, #ef4444);
        }

        #customTimeStatusRegular.alert-info,
        #customTimeStatusPackage.alert-info {
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center gap-2">
                <span class="nav-user">
                    ...
                    <span>{{ auth()->guard('customer')->user()->first_name }}
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm sticky-top" style="top: 20px;">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('reservation.request.regular.route', $hall->id) }}"
                        id="regularForm" class="{{ $hall->booking_method === 'package' ? 'hidden' : '' }}"
                        ...
                        <div class="mb-4 hidden">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted">Time needed before event for setup (Max:
                                        {{ $hall->max_pre_arrange_hours ?? 5 }} hours)</small>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <small class="form-text text-muted">Time needed after event for cleanup (Max:
                                        {{ $hall->max_post_arrange_hours ?? 5 }} hours)</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="regularCharges">
                            ...
                            @if ($hall->discount > 0)
                                <div class="mb-3 p-3 bg-light rounded">
                                    <h5 class="mb-0">Hall Discount: <span id="propertyDiscountRegular">Rs.
                                            {{ $hall->discount }}</span></h5>
                                </div>
                            @endif
                            <div class="mb-3 p-3 bg-light rounded">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="agree_terms"
                                    id="agreeTermsRegular" value="1" required>
                    ...
                    <form method="POST" action="{{ route('reservation.request.package.route', $hall->id) }}"
                        id="packageForm" class="{{ $hall->booking_method === 'package' ? '' : 'hidden' }}"
                        enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="packageCharges">
                            ...
                            <div id="packageFacilitiesChargeSection" class="mb-3 p-3 bg-light rounded"
                                style="display: none;">
                                <h5 class="mb-0">Facilities Charge: <span id="packageFacilitiesCharge">Rs. 0.00</span>
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="agree_terms"
                                    id="agreeTermsPackage" value="1" required>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                                    ...
                                    @foreach ($hall->packages as $package)
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="card package-card h-100" data-duration="{{ $package->duration }}"
                                                ...
                                                data-discount="{{ $package->discount ?? 0 }}"
                                                ...
                                                <div class="card-footer text-center">
                                                    ...
                                                    @endif
                                                    <br><span class="text-muted">Duration: {{ $package->duration }}
                                                        hours</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="facility-item">
                                        <div class="form-check">
                                            <input class="form-check-input package-unit-facility" type="checkbox"
                                                value="{{ $up_facility->charge }}"
                                                id="pkg_unit_facility_{{ $up_facility->id }}"
                                                data-price="{{ $up_facility->charge }}"
                                            ...
                                            <div class="mt-2" style="padding-left: 1.5rem;">
                                                <div class="input-group input-group-sm" style="max-width: 180px;">
                                                    ...
                                                    <input type="number" class="form-control package-unit-facility-hours"
                                                        ...
                                                        data-facility-id="{{ $up_facility->id }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <button class="btn btn-primary open-map-btn mt-2" data-lat="{{ $hall->latitude }}"
                            data-lng="{{ $hall->longitude }}">
                    ...
                    <button class="btn btn-primary open-terms-btn mt-2"
                        data-pdf="{{ asset('storage/' . $hall->clearence_form) }}">
