                    ...
                    <div class="card-body">
                        ...
                        @foreach($halls as $hall)
                            <div class="hall-badge"
                                style="background-color: {{ $hall->calendar_color ?? '#' . substr(md5($hall->id), 0, 6) }}; color: white;">
                                {{ $hall->name }}
                            </div>
                        @endforeach
                        ...
                        @php
                            $calendarStatuses = [1, 2, 3, 4, 5, 6, 7, 8];
                        @endphp
                        @foreach($calendarStatuses as $calendarStatus)
                            @php
                                $statusMeta = \App\Http\Controllers\ReservationController::getReservationStatusMeta($calendarStatus);
                            @endphp
                            <div class="legend-item">
                                <div class="legend-color" style="background-color: {{ $statusMeta['color'] }};"></div>
                    ...
                    const detailsHtml = `
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Status:</strong> <span class="badge" style="background-color:${props.status_color}; color:${props.status_text_color};">${props.status}</span></p>
                            </div>
                            <div class="col-md-6">
