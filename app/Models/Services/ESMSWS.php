...
{ 
	...
	function getClient()
	{
		...
		{
            throw new \RuntimeException('SOAP extension not installed');
        }

		ini_set("soap.wsdl_cache_enabled", "0");
		$client = new \SoapClient("https://msmsenterpriseapi.mobitel.lk/mSMSEnterpriseAPI/mSMSEnterpriseAPI.wsdl",['cache_wsdl' => WSDL_CACHE_NONE,'trace' => 1,'exceptions' => true]);

		return $client;

		// Use the global SoapClient with backslash prefix
        //return new \SoapClient("https://msmsenterpriseapi.mobitel.lk/mSMSEnterpriseAPI/mSMSEnterpriseAPI.wsdl", ['cache_wsdl' => WSDL_CACHE_NONE,'exceptions' => true]);

	}


	//serviceTest
	function serviceTest($id,$usernamer,$password,$customer)
	{
